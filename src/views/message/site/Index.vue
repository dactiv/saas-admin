<template>
  <div>
    ...
    <a-card title="站内信管理" class="basic-box-shadow margin-lg-top">
          ...
          <a-dropdown size="small" type="text" placement="bottomLeft">
            <template #overlay>
              <a-menu @click="handleMenuClick" >
                ...
                <a-menu-item key="delete" :disabled="this.selectedIds.length <= 0 || !this.principal.hasPermission('perms[site:delete]')">
                  <a-space>
    ...
    <a-modal v-model:visible="this.searchDialogVisible" class="width" title="查询站内信消息" @ok="search(null)" layout="vertical">
...
export default {
  ...
  methods:{
    ...
    remove(ids) {
      ...
      this
          .$http
          .post("/api/message/site/delete",this.formUrlEncoded({ids:ids})).then((r) => {
